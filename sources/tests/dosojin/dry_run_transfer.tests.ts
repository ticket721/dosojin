...
export function dry_run_transfer_tests(): void {
    ...
    test('throw dosojin error when transfer status is null', async () => {
        ...
        await expect(dosojin.dryRunTransfer(gem)).rejects.toThrow();
    ...
    test('dry run gem on connector when dosojin contains corresponding connector', async () => {
        const expectedConnectorName: string = 'connector';
        ...
        await dosojin.dryRunTransfer(gem);
    ...
    test('dry run gem on receptacle when dosojin contains corresponding receptacle', async () => {
        const expectedReceptacleName: string = 'receptacle';
