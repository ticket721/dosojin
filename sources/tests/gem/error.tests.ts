...
export function error_tests(): void {
    ...
    test('set error info and gem status to \'Error\' when connector transfer status is set', () => {
        const expectedDosojinName: string = 'dosojin';
        const expectedConnectorName: string = 'connector';
        const expectedLayer: number = 0;
        const expectedMessage: string = 'testing error message';
        ...
        gem.error(dosojin, expectedMessage);
    ...
    test('set error info and gem status to \'Error\' when receptacle transfer status is set', () => {
        const expectedDosojinName: string = 'dosojin';
    ...
    test('set error info and gem status to \'Error\' when operation status is set', () => {
        const expectedDosojinName: string = 'dosojin';
